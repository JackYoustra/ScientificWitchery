...
[^6]: On macOS, use `mount_bindfs` from Homebrew (`brew install bindfs`) instead: `bindfs /path/to/dependencies /path/to/project/deps`. On Windows, consider using directory junctions: `mklink /J C:\path\to\project\deps C:\path\to\dependencies`
