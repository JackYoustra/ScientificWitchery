...
[has the SIL of the follwing](https://gcc.godbolt.org/z/YhdMM4bYY)[^1]
...
[^2]:
    ...
    For more on what the `@guaranteed` means, check out the (imo) veryfun to read [SIL docs](https://github.com/swiftlang/swift/blob/main/docs/SIL.rst#ownership-kind) on the matter.
