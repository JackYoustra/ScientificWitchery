...
// TODO: introduction on current SOTA Swift codegen
...
It has an attached ["pitch"](https://gist.github.com/DougGregor/4f3ba5f4eadac474ae62eae836328b71) and a slimmed-down expression macros [pitch](https://github.com/DougGregor/swift-evolution/blob/expression-macros/proposals/nnnn-expression-macros.md)
(currently awaiting implementation).

Before I go into this proposal, it would be good to review its inspiration:
...
I can't wait for it to land in stable and I can finally start working on a [TCA state sharing macro](/blog/tca-state-sharing).