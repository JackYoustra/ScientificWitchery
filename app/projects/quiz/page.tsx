  ...
  return (
    <>
      <h2 className="text-2xl font-bold text-center italic">
        I can't find the neoliberal project's buzzfeed quiz anymore, so I made my own copy of it. Enjoy!
      </h2>
      <hr/>
      <BuzzFeedQuiz
        ...
        bylineAuthorLink={"https://web.archive.org/web/20201229055816/https://www.buzzfeed.com/neoliberalproject"}
        bylineAuthorLinkOpenInNewTab={true}
        bylineAuthorTagline={"Community Contributor"}
        bylineAvatarImageSrc={"https://img.buzzfeed.com/buzzfeed-static/static/avatars/beagle_large.jpg?resize=100:100&quality=auto"}
        autoScroll={true}
        ...
        copyShareLink={"Find out what your job will be once the revolution happens at www.jackyoustra.com/projects/quiz."}
        questions={[
          {
        ...
        results={[
          {
            ...
            description: "Rejoice, comrade! The Central Committee has determined your ideal new job in our socialist utopia - collective farm labor. Your comrades in the army will be along shortly to escort you and your family to a new, socialist home.",
            resultImageSrc: "https://www.encyclopediaofukraine.com/pic%5CC%5CO%5CCollective%20farm%20propaganda%20poster.jpg",
